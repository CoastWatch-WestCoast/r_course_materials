...
<!-- -->
    ...
    ##  Dimensions (range):  
    ##      time: (1997-10-16T12:00:00Z, 2010-12-16T12:00:00Z) 
    ##      altitude: (0.0, 0.0) 
    ##      latitude: (-90.0, 90.0) 
    ##      longitude: (0.0, 360.0) 
    ##  Variables:  
...
<!-- -->
    ...
    ##  Dataset Type: griddap 
    ##  Dimensions (range):  
    ##      time: (2003-01-16T00:00:00Z, 2021-03-16T00:00:00Z) 
...
![](04-timeseries_chl_files/figure-markdown_strict/plot-1.png)
...
![](04-timeseries_chl_files/figure-markdown_strict/plotall-1.png)
...
![](04-timeseries_chl_files/figure-markdown_strict/maps-1.png)
